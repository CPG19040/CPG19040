...
"}")
        ...
        self.labelPosition.setStyleSheet(u"color: rgb(190, 190, 190); background-color: transparent; margin-left: 10px; font: 57 10pt \"Inter Medium\";")
...
"}")
    ...
    def retranslateUi(self, Home):
        ...
        self.btnLesson.setText(QCoreApplication.translate("Home", u"Lessons", None))
        ...
        self.btnUtility.setText(QCoreApplication.translate("Home", u"Settings and Utilities", None))

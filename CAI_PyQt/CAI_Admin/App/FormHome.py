...
"}")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 21, 18))
...
"}")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 20, 18))
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 21, 18))
...
"}")
    ...
    def retranslateUi(self, Home):
        ...
        self.checkBoxLockQuiz.setText(QCoreApplication.translate("Home", u"Lock Quiz", None))
